This page contains version history information about the plug-in.  
You can directly go to a version history detail by clicking on a version link from the list below.
...
[← Previous](Feature.md) | [Next →](49.1.0.md)